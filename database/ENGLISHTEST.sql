...
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES ('3', '9', time('00:15:00') ,TIMESTAMP('2022/05/20'));
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES ('3', '8', time('00:13:00') , TIMESTAMP('2022/05/20'));
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES ('4', '9', time('00:14:00'),  TIMESTAMP('2022/05/21'));
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES ('4', '10', time('00:17:00'), TIMESTAMP('2022/05/22'));
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES ('4', '10',time('00:14:00'), TIMESTAMP('2022/05/20'));
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES ('4', '7', time('00:11:00'),TIMESTAMP('2022/05/20'));
INSERT INTO RESULT_TEST (`ID_USER`, `SCORES`, `TIMED` ,  `DATE_TEST`) VALUES (3, 7.5, time('00:11:00'),TIMESTAMP('2022/05/20'));

select * from result_test; 

INSERT INTO BXH (`ID`, `SCORES` , `TIMED`) VALUES (3 , 9 ,time('00:11:00'));
INSERT INTO BXH (`ID`, `SCORES`, `TIMED`) VALUES (4 , 9,time('00:11:00'));
INSERT INTO BXH (`ID`, `SCORES`, `TIMED`) VALUES (2 , 8,time('00:11:00'));
